...
//Double_t da_cut = 0.12 ;//kawahara
//Double_t dp_cut = 20.0 ;//kawahara
//Double_t da_cut = 0.15 ;
//Double_t dp_cut = 50.0 ;
//Double_t da_cut = 0.23 ;
//Double_t dp_cut = 19.8 ;
...
void cut_signal_roughly( TString ifname = "ninja_shifter_bt063_tracker_matching.root" )
{
	...
	SetStyle() ;
	TString psname = "Plot_" + ifname + ".pdf" ;
